...
x1 = csvread('E:\DoYeon\Document\5. Program\Reconstruction\4.MLEM_RECON\LM_MLEM_3D\Paper_data\1.(2,1,2)_827.csv');
x2 = csvread('E:\DoYeon\Document\5. Program\Reconstruction\4.MLEM_RECON\LM_MLEM_3D\Paper_data\2.(0,1,2)1275.csv');
x3 = csvread('E:\DoYeon\Document\5. Program\Reconstruction\4.MLEM_RECON\LM_MLEM_3D\Paper_data\3.(-3,1,2)438.csv');
x4 = csvread('E:\DoYeon\Document\5. Program\Reconstruction\4.MLEM_RECON\LM_MLEM_3D\Paper_data\4.(-2.12,1,4.949)199.csv');
x5 = csvread('E:\DoYeon\Document\5. Program\Reconstruction\4.MLEM_RECON\LM_MLEM_3D\Paper_data\5.(1,1,5)_240.csv');
x6 = csvread('E:\DoYeon\Document\5. Program\Reconstruction\4.MLEM_RECON\LM_MLEM_3D\Paper_data\6.(0,1,5)211.csv');
x7 = csvread('E:\DoYeon\Document\5. Program\Reconstruction\4.MLEM_RECON\LM_MLEM_3D\Paper_data\7.(-1,1,5)228.csv');
...
camera_direction3 = [-1 0 0];
camera_direction4 = [-0.7071 0 -0.7071];
camera_direction5 = [0 0 -1];
...
for i=1:compton.cnt-1
    if (compton.angle(i,1) <= 1 && compton.angle(i,1) >= -1)
        for j=1:td.nGrid
            ...
            z = td.zStart+fix(j/(td.WIDTH*td.HEIGHT/(td.RESO^2)))*0.5;
            %pixel = [xy(1) z xy(2)];
            pixel = [xy(1) z xy(2)];
